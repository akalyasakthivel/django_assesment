...
class Eventdetails(models.Model):
    id = models.AutoField(primary_key=True)
    event=models.CharField(max_length=250,blank=False,null=False)
...
class Persona(models.Model):
    id = models.AutoField(primary_key=True)
    persona=models.CharField(max_length=250,blank=False,null=False)

class Screeningmode(models.Model):
    id = models.AutoField(primary_key=True)
    screening_mode=models.CharField(max_length=250,blank=False,null=False)
...
class Employeedirectory(models.Model):
    id = models.AutoField(primary_key=True)
    referred_by=models.CharField(max_length=250,blank=False,null=False)
...
class Experiencelevel(models.Model):
    id = models.AutoField(primary_key=True)
    experience_level=models.CharField(max_length=250,blank=False,null=False)

class Educationlevel(models.Model):
    id = models.AutoField(primary_key=True)
    education_level=models.CharField(max_length=250,blank=False,null=False)
...
class Educationspecialization(models.Model):
    id = models.AutoField(primary_key=True)
    education_specialization=models.CharField(max_length=250,blank=False,null=False)

class Source(models.Model):
    id = models.AutoField(primary_key=True)
    education_institution=models.CharField(max_length=250,blank=False,null=False)
    source=models.CharField(max_length=250,blank=False,null=False)

class Sourcetype(models.Model):
    id = models.AutoField(primary_key=True)  
    source_type=models.CharField(max_length=250,blank=False,null=False)

class Reasonforchange(models.Model):
    id = models.AutoField(primary_key=True)
    reason_for_change=models.CharField(max_length=250,blank=False,null=False)
